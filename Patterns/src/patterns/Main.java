...
//5&6
//З метою усунення запахів коду та рефакторингу (останні дві лабораторні, 5 і 6) я вніс зміни в класи Database, Agreement та AgreementBuilder, AgreementBridge, ComplexDocument, AgreementFacade, Decorator і ServiceFlyweightFactory.
//Щодо обсягу коду, майже скрізь він зріс (крім 2 класів), але читабельність коду залишилася на колишньому рівні.
//Я додав хандлери та екзепшинів там де їх не було, але й варто було додати для опрацювання потенційних помилок.
//Також розширив реалізації патернів. Тестування показало, що помилок під час рефакторингу не з'явилося (у поточному варіанті, раніше були, але я їх виправив).
//Що стосується переміщення методів, я спочатку реалізував за допомогою спеціальних патернів там, де це було доречно.
package patterns;
